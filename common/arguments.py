...
def parse_args():
    ...
    parser.add_argument('-sup', '--subjects-supervised', default='', type=str, metavar='LIST',
                        help='labeled subjects separated by comma for supervision')
    ...
    parser.add_argument('--model_name',default='',type=str,help='Name of the model to be saved.')
    ...
    parser.add_argument("--bone_length_term_generator", action='store_true', help="Whether to use bone length loss for generator")
    parser.add_argument("--bone_length_term_discriminator", action='store_true', help="Whether to use bone length loss for discriminator")
    parser.add_argument("--bone_length_consistency", action='store_true', help="Whether to use bone length constistency or not")
    ...
    parser.add_argument("--critic_Repnet", action='store_true', help="Whether to use RepNet's discriminator or use the default GRU critic")
    parser.add_argument("--critic_CNN", action='store_true', help="Whether to use CNN discriminator or use the default GRU critic")
    parser.add_argument("--Semi", action='store_true', help="Whether to perform sei supervised training or not")
    parser.add_argument("--GAN_PROJ", action='store_true', help="Whether to perform advarsarial training or not")
    parser.add_argument("--multi_projection",action='store_true',help="whether to perform multi-projection or not")
    parser.add_argument("--GAN", action='store_true', help="Whether to perform advarsarial training or not")
    parser.add_argument('-lr_GAN', '--learning-rate_GAN', default=0.001, type=float, metavar='LR', help='initial learning rate')
